...
export function CreateVampire({
  ...
  const spendAuditLines = useMemo(() => {
    ...
    const clanDiscIds = new Set(getClanDisciplineIds(nowChar?.clanId ?? null));
    ...
    allDiscIds.forEach((id) => {
      ...
      if (!isPhase2) {
        ...
        if (freebieDots > 0) {
          const costPerDot = freebieCost.getCost(
            ...
            <div className="sheetActive">
              ...
              <div className="sheetSection">
                ...
                <div className="personaGrid personaGridCreate">
                  ...
                  {/* ===== ROW 2: Player | Demeanor | Generation ===== */}
                  <p className="personaRow">
                ...
                <div className="personaGrid hrTop personaGridCreate">
                  <p>
                ...
                <div className="grid3">
                  ...
                  <div>
                    ...
                    <div className="healthGrid">
                      {healthLevels.map(({ label, penalty }, index) => (
                        <div
                          className="healthRow"
                          key={`${label}-${index}`}
                          style={{
