...
const HumanGhoulCharacterSheet: React.FC<CharacterSheetProps> = ({
  mode,
  sheet,
  onSubmit,
  characterStatus,
        ...
        <>
          ...
          <section className="sheetSection">
            ...
            <div className="personaGrid personaGridCreate">
              ...
              {/* Linha 2: Player, Demeanor, Family */}
              <p className="personaRow">
              ...
              {/* Linha 3: Chronicle, Concept, Domitor */}
              <p className="personaRow">
...
export default HumanGhoulCharacterSheet;
